 <footer id="footer">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="featured-box text-center">
                ...
                <h4>Refer & Earn</h4>
                <p>Invite a friend to sign up and earn up to Tk.100.</p>
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
              <div class="featured-box text-center">
        ...
        <div class="row">
          <div class="col-md-4 mb-3 mb-md-0">
            ...
            <ul class="payments-types">
              <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('frontend/images/payment/visa.png')}}" alt="visa"
                    title="Visa"></a></li>
              <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('frontend/images/payment/discover.png')}}"
                    alt="discover" title="Discover"></a></li>
              <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('frontend/images/payment/bkash-logo-rsz.png')}}" alt="bKash"
                    title="bKash"></a></li>
              <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('frontend/images/payment/american.png')}}"
                    alt="american express" title="American Express"></a></li>
              <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('frontend/images/payment/mastercard.png')}}"
                    alt="discover" title="Discover"></a></li>
            </ul>
          </div>
          <div class="col-md-4 mb-3 mb-md-0">
          ...
          <div class="col-md-4 d-flex align-items-md-end flex-column">
            ...
            <ul class="social-icons">
              ...
              <li class="social-icons-google"><a data-toggle="tooltip" href="http://www.google.com/" target="_blank"
                  title="Google"><i class="fab fa-google"></i></a></li>
              <li class="social-icons-linkedin"><a data-toggle="tooltip" href="http://www.linkedin.com/" target="_blank"
      ...
      <div class="container">
        <div class="footer-copyright">
          ...
          <p class="copyright-text">Copyright © 2019 <a href="#">aamarApp by aamarPay</a>. All Rights Reserved. Soft
            Tech Innovation Ltd.</p>
        </div>
      </div>
    </footer><!-- Footer end -->