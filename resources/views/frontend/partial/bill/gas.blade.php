 <div class="gas" id="gas" style="display: none;">
            ...
            <div class="container">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab"
                    href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Gas Bill
                    Payment</a> </li>
              ...
              <div class="tab-content my-3" id="myTabContent">
                <div class="tab-pane fade show active" id="mobile-recharge" role="tabpanel"
                  ...
                  <p>Instant Online Gas Bill Payment Iisque persius interesset his et, in quot quidam persequeris vim, ad
