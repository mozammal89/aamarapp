  <div class="broadband" id="broadband" style="display:none;">
                  ...
                  ============================================= -->
                    <div class="col-lg-4 mb-4 mb-lg-0">
                      ...
                      <form id="broadbanadBill" method="post">
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control" data-bv-field="number" id="telephoneNumber" required
                    ...
                    </div><!-- Broadbanad Bill end -->
        
                    <!-- Slideshow
                  ============================================= -->
                    <div class="col-lg-8">
                      <div class="owl-carousel owl-theme slideshow single-slider">
                        <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-4.jpg')}}"
                              alt="banner 4" /></a></div>
                        <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-7.jpg')}}"
                              alt="banner 3" /></a></div>
                        <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-5.jpg')}}"
                              alt="banner 5" /></a></div>
                      </div>
                    </div><!-- Slideshow end -->
                ...
                <div class="container">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab"
                        href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Broadband Bill
                        Payment</a> </li>
