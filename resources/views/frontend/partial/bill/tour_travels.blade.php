 <div class="tours" id="tours" style="display:none;">
                  ...
                  <div class="row banner">
                    <div class="col-md-8">
                      <div class="item rounded align-middle"> <a href="#">
                          ...
                          <img class="img-fluid" src="images/brands/hotels/coxsbazar.jpg" alt="hotels">
                        </a> </div>
                    </div>
                    <div class="col-md-4">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="item rounded"> <a href="#">
                              ...
                              <div class="banner-mask"></div>
                              <img class="img-fluid" src="images/brands/hotels/rangamati.jpg" alt="hotels">
                            </a> </div>
                        </div>
                        <div class="col-md-12 mt-4">
                          <div class="item rounded"> <a href="#">
                              ...
                              <div class="banner-mask"></div>
                              <img class="img-fluid" src="images/brands/hotels/kaptai.jpg" alt="hotels">
                            </a> </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row banner mt-4 mb-2">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="item rounded"> <a href="#">
                              ...
                              <div class="banner-mask"></div>
                              <img class="img-fluid" src="images/brands/hotels/sajek.jpg" alt="sajekvalley">
                            </a> </div>
                        </div>
                        <div class="col-md-12 mt-4">
                          <div class="item rounded"> <a href="#">
                              ...
                              <div class="banner-mask"></div>
                              <img class="img-fluid" src="images/brands/hotels/bandarban.jpg" alt="Bandarban">
                            </a> </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="item rounded align-middle"> <a href="#">
                          ...
                          <div class="banner-mask"></div>
                          <img class="img-fluid" src="images/brands/hotels/Sylhet2.jpg" alt="Bichanakandi, Sylhet">
                        </a> </div>
                    </div>
                  </div>
